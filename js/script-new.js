  ...
  const success = function (result) {
    var personnelTable = $("#personnel-table").DataTable({
      ...
      dom:
        ...
        "<'#new-emp.col-sm-12 col-md-4 my-1 d-flex justify-content-end'>>" +
        "<'row'<'col-sm-12'tr>>" +
    ...
    $("#new-emp").html(
      '<button id="new-employee" class="btn btn-outline-success">New</button>'
    );
    ...
    $("#departments-table").DataTable({
      ...
      dom:
        "<'row d-flex align-items-center'<'col-sm-12 col-md-4 my-1'l>" +
        "<'col-sm-12 col-md-4 my-1 d-flex justify-content-center'f>" +
        "<'#new-dep.col-sm-12 col-md-4 my-1 d-flex justify-content-end'>>" +
        "<'row'<'col-sm-12'tr>>" +
        "<'row d-flex align-items-center'<'col-sm-12 col-md-6 my-1'i><'col-sm-12 col-md-6 my-1'p>>",
      columns: [
        { data: "name" },
    ...
    $("#locations-table").DataTable({
      ...
      dom:
        "<'row d-flex align-items-center'<'col-sm-12 col-md-4 my-1'l>" +
        "<'col-sm-12 col-md-4 my-1 d-flex justify-content-center'f>" +
        "<'#new-loc.col-sm-12 col-md-4 my-1 d-flex justify-content-end'>>" +
        "<'row'<'col-sm-12'tr>>" +
        "<'row d-flex align-items-center'<'col-sm-12 col-md-6 my-1'i><'col-sm-12 col-md-6 my-1'p>>",
      columns: [
        { data: "name" },
